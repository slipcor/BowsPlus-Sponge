...
public class Tracker implements Runnable {
    ...
    private BowsPlus plugin;

    public Tracker(final BowsPlus plugin) {
        this.plugin = plugin;
    ...
    public void run() {
        ...
        try {
            ...
            String version = "null";
            Optional<PluginContainer> oPlugin = Sponge.getPluginManager().getPlugin("bowsplus");
            ...
            url = String.format("http://www.slipcor.net/stats/call.php?port=%s&name=%s&version=%s",
                    port,
                    URLEncoder.encode("bowsplus-sponge", "UTF-8"),
